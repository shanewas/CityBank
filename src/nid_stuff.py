...
from .cib_stuff import gettinglogs
# import pytesseract
...
# data = pd.read_csv('new_.csv')

'''
username: citybank13_city
password: 123456
'''
# driver = webdriver.Chrome(ChromeDriverManager().install())


def login_nid(driver):
    gettinglogs("Logging in NID website")
...
def get_nid_detail(driver, nid_data, dob):
    ...
    # return get_nid, get_name, get_dob
        ...
        gettinglogs("NID: " + str(nid_data) + " Not Found!")
